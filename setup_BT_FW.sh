...
echo "Run this script to download the various firmwares for broadcom based adapters and copy the .hcd file that it is complaining about from the /broadcom-bt-firmware/brcm/ directory to /lib/firmware/brcm, then reboot or reinsert the adapter
